...
§§§ Турнир по КВРМ должно иметь собственный регламент, положения которого не должны противоречить настоящим Правилам.
...
§§§tours Игра может состоять из одного тура или быть разбита на несколько туров. Каждый тур не может состоять менее, чем из 6 вопросов. Команда, правильно ответившая на большее количество вопросов отдельного тура, всегда занимает в данном туре более высокое место, чем команда, правильно ответившая на меньшее количество вопросов. Если команды участвовали в одних и тех же турах, команда, сыгравшая лучше каждый тур, всегда побеждает команду, сыгравшую хуже каждый тур.
...
Редакционная группа турнира может быть единой, либо своя редакционная группа может быть у каждого [тура](^^tours).
...
Зрителями являются лица, присутствующие на турнире, но не выступающие ни в одной из вышеперечисленных ролей. Регламент турина может ограничивать или запрещать присутствие зрителей.
...
- в это время команды записывают и фиксируют ответы. Регламент турнира может допускать сдачу ответов при помощи электронных устройств. После объявления счёта «0» изменение или написание ответа запрещено;
...
Члены организационной группы должны стараться обеспечить, чтобы членам апелляционного жюри до окончания их работы не были известны личности апеллянтов.
...
f. он указывает на реалию (реалии), не содержащиеся в авторском ответе или критериях зачёта, однако при этом существует такая интерпретация текста вопроса, что он соответствует всем условиям вопроса не хуже, чем авторский ответ или ответ, соответствующий критериям зачёта.

Ответы, уже зачтённые ИЖ и АЖ, для целей пункта <^^right_answer> следует считать эквивалентными ответам, соответствующим критериям зачёта.
...
f. он содержит более одного ответа, причём как минимум один из них нельзя засчитать в качестве верного ответа согласно п. <^^answer_is_right>.
g. вследствие неразборчивости он имеет несколько вариантов прочтения и как минимум один из них нельзя засчитать в качестве верного ответа согласно п. <^^answer_is_right>.
h. он отклонён по техническим причинам в соответствии с пунктом <^^tech_reject>.
...
§§§zachet_extension Редактор может расширить поле «Зачёт» в вопросах подготовленных им туров в любой момент до окончания отыгрыша турнира. После этого он сообщает о своём решении членам технической группы, а те при необходимости вносят изменения в таблицу.

Редактор имеет право передать полномочия по расширению зачёта игровому жюри либо другому члену редакционной группы турнира.

[Этот пункт вступает в действие только в случае принятия соответствующих поправок в Положение об эгиде и рейтинге.] Игровое жюри имеет право расширять поле «Зачёт», даже если редактор не передавал им полномочия, в случае, если это указано в регламенте турнира. [Такой турнир не может быть рейтингован.]

§§§ Коммуникация между членами АЖ, ИЖ и редакторами не запрещена. В частности, члены АЖ и ИЖ могут (по своей инициативе или по просьбе команды) посоветовать редакторам расширить зачёт, включив туда тот или иной ответ, однако редактор не обязан прислушиваться к их советам.
...
Заочный турнир — вид турнира, участие в котором команды принимают в разное время в течение отведённого периода. Отдельные члены организационной и технической групп выполняют свои функции лишь в отношении участников той игровой площадки (площадок), на которой(ых) они находятся во время соответствующего отыгрыша. 
