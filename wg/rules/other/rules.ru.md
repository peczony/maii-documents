...
Редакционная группа включает в себя редакторов и авторов вопросов. Редакторы готовят пакет вопросов для проведения соревнования, основываясь на фактах и идеях авторов вопросов. Редакторы предоставляют организационной группе список авторов.
...
Поле «Зачёт» может быть расширено редакторами в процессе отыгрыша турнира (см. п. [1\.7\.7](#1.7.7)).
...
1\.7\.1\.<span id="1.7.1"></span> Ответ считается правильным, если:
...
g. он содержит более одного ответа, причём как минимум один из них нельзя засчитать в качестве верного ответа согласно п. [1\.7\.1](#1.7.1).
h. вследствие неразборчивости он имеет несколько вариантов прочтения и как минимум один из них нельзя засчитать в качестве верного ответа согласно п. [1\.7\.1](#1.7.1).
j. он отклонён по техническим причинам в соответствии с пунктом [4\.2](#4.2).
...
Техническая группа включает ответ команды в список спорных, если считает его правильным в соответствии с подпунктами e–g пункта [1\.7\.1](#1.7.1). При любых сомнениях технической группе следует не засчитывать ответ, а включить его в список спорных.

1\.7\.4\.<span id="1.7.4"></span> Игровое жюри засчитывает в качестве правильного ответ команды, в случае если считает его правильным в соответствии с подпунктами a–f пункта [1\.7\.1](#1.7.1).
...
1\.7\.7\.<span id="1.7.7"></span> Редактор может расширить поле «Зачёт» в подготовленных им вопросах в любой момент до окончания отыгрыша турнира. После этого он сообщает о своём решении членам технической группы, а те при необходимости вносят изменения в таблицу.
...
1\.7\.8\.<span id="1.7.8"></span> Коммуникация между членами АЖ, ИЖ и редакторами не запрещена. В частности, члены АЖ и ИЖ могут (по своей инициативе или по просьбе команды) посоветовать редакторам расширить зачёт, включив туда тот или иной ответ, однако редактор не обязан прислушиваться к их советам.
