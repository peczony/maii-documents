...
>
> ==Допускается выполнение функций ведущего онлайн по аудио- или видеосвязи. Но и в этом случае на площадке должен присутствовать член технической группы, который выполняет функции по сбору ответов и контролю времени.==
...
>
> Если вопрос состоит из нескольких подвопросов, то как правило, команде засчитывается засчитывается правильный ответ только в том случае, если она правильно ответила на все подвопросы. Однако если в вопросе и критериях зачёта явно указан иной принцип зачёта, оценивать правильность ответа следует в соответствии с ними.
> 
